...
No Tracks: 
/mnt/ceph/users/pzehetner/Paper/Train_cut11_noPU_noTracks_new/dataCollection.djcdc
...
LOSS_OPTIONS = {
    ...
    'beta_loss_scale':2., #2.0
    'beta_push': 0.01,#0.01 or 0.00 #push betas gently up at low values to not lose the gradients
    }
...
# PRESELECTION_PATH = '/mnt/home/pzehetner/precluster_v4_merge/KERAS_check_best_model.h5'
PRESELECTION_PATH = '/mnt/home/pzehetner/NoiseTraining0/KERAS_check_model_block_2_epoch_62.h5'
...
train.change_learning_rate(LEARNINGRATE/1.)
model, history = train.trainModel(
    nepochs=100, 
    batchsize=NBATCH, 
    additional_callbacks=cb
