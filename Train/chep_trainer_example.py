...
def gravnet_model(Inputs,
    ...
    for i in range(total_iterations):
        ...
        raise ValueError("this is broken here, needs a backscatter or gather. ")
        '''
        x here has different dimension after prefiltering, see the other training scripts
        '''
        allfeat.append(x)
    ...
    '''
    The appended features abore are not used
    '''
