...
from running_plots import RunningEfficiencyFakeRateCallback, RunningScalarMetric
...
from window_analyser import DatasetAnalyser
...
cb += [RunningScalarMetric(td, tensorboard_manager)]
