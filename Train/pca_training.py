'''
This is a copy of `june_format_example_nf_pca_double_coords.py`, 
which should additionally include a test of the approximatePCA layer
'''
...
def gravnet_model(Inputs,
    ...
    # TODO: Check if this actually are the coordinates
    ...
    total_iterations=3 # Changed from 5 to 1
