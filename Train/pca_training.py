...
from Layers import CreateGlobalIndices, CreateTruthSpectatorWeights
...
def gravnet_model(Inputs,
    ...
    ###########################################################################
    ### GraveNet, MessagePassing and PCA ######################################
    ###########################################################################
    ...
    energysums.append(MultiBackGather()([energy, gatherids]))
