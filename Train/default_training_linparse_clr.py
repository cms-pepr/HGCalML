...
loss_config.payload_rel_threshold = 0.8
...
model, history = train.trainModel(nepochs=1+4,
                                  run_eagerly=True,
                                  batchsize=nbatch,
                                  batchsize_use_sum_of_squares=False,
                                  checkperiod=1,  # saves a checkpoint model every N epochs
...
loss_config.position_loss_weight=3e-3

model, history = train.trainModel(nepochs=1+4+50,
                                  run_eagerly=True,
                                  batchsize=nbatch,
                                  batchsize_use_sum_of_squares=False,
                                  checkperiod=1,  # saves a checkpoint model every N epochs
