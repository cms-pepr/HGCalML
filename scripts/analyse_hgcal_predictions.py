    ...
    for i, file in enumerate(files_to_be_tested):
        ...
        for j, endcap_data in enumerate(file_data):
            ...
            if event_id < 2:
                ...
                fig_cluster_pca = dataframe_to_plot(full_df, truth=False, clusterspace='pca', plot_detector=False)
                fig_cluster_first = dataframe_to_plot(full_df, truth=False, clusterspace=(0,1,2), plot_detector=False)
