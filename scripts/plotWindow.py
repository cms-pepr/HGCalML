...
import random
from datastructures import TrainData_NanoML, TrainData_NanoMLPF, TrainData_Cocoa
...
def toDataFrame(thegen, thetd):
    ...
    return TrainData_NanoML.createPandasDataFrame(data, 0)
