...
class LLFullObjectCondensation(LossLayerBase):
    ...
    def calc_energy_correction_factor_loss(self, t_energy, t_idx, hit_energy, pred_energy,pred_energy_low_quantile,pred_energy_high_quantile, row_splits): 
        #
        # all V x 1
        #
        depe=[]
    ...
    def loss(self, inputs):
        ...
        pred_beta, pred_ccoords, pred_distscale, pred_energy, pred_energy_low_quantile,pred_energy_high_quantile,\
        ...
        if self.train_energy_correction:
            energy_loss, energy_quantiles_loss =  self.calc_energy_correction_factor_loss(t_energy, 
                                                                                            t_idx, 
                                                                                            rechit_energy, 
                                                                                            pred_energy,
