...
class TrainData_PrepoolNanoML(TrainData):

    model_keys = None

    def set_model(self):
        self.path_to_pretrained = os.getenv("HGCALML")+'/models/tiny_pc_pool/model.h5'
    ...
    def __init__(self):
        ...
        if TrainData_PrepoolNanoML.model_keys is None:
            TrainData_PrepoolNanoML.model_keys=_getkeys(self.path_to_pretrained)#load only once
        ...
        self.output_keys = TrainData_PrepoolNanoML.model_keys
...
class TrainData_PreselectionNanoMLPF2(TrainData_PrepoolNanoML):
