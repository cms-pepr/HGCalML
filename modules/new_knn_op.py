...
_nknn_op = tf.load_op_library('new_knn.so')

def NewKnn(K : int, coords,  row_splits, tf_compatible=True, max_radius=-1., n_bins_x=2, n_bins_y=2):
    '''
    todo
    '''

    return _nknn_op.NewKnn(n_neighbours=K, tf_compatible=tf_compatible, max_radius=max_radius,
